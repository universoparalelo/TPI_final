        ...
        <div className="overflow-x-auto min-h-[500px]">
            <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                ...
                <tbody className="text-gray-700 text-sm divide-y divide-gray-200">
                    ...
                    <tr key={index}>
                        <td className="text-left py-3 px-5">{tarifa.vehiculo}</td>
                        <td className="text-left py-3 px-5">{tarifa.marca}</td>
                        <td className="text-left py-3 px-5">{tarifa.modelo}</td>
                        <td className="text-left py-3 px-5">{tarifa.categoria}</td>
                        <td className="text-left py-3 px-5">{tarifa.frecuencia}</td>
                        <td className="text-left py-3 px-5">{tarifa.precio}</td>
