      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div className="flex justify-center items-center min-h-screen py-12 px-6 lg:px-8">
          ...
          <div className="space-y-12">
            ...
            <p className="mt-1 text-sm text-gray-600">Utilice un correo electrónico válido y actual. Los cambios en el turno seran infrormados por allí</p>
            ...
            <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-lg font-semibold text-gray-900">Vehiculo</h2>
            <p className="mt-1 text-sm text-gray-600">Ingrese los datos del vehiculo</p>
