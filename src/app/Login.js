        ...
        <form>
          ...
          <div className="flex justify-end mt-10 items-center gap-4">
            <button
              type="button"
              onClick={onClose}
              className=" items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-black hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2"
            >
              Cancelar
            </button>
            <button
